  ...
  return (
    creator && (
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="bg-[#9f9f9f] rounded-xl p-6 md:mt-0 border-2 border-[#a4a4a4] drop-shadow-md w-11/12 lg:w-1/3">
          ...
          <div className="art-scrollbar p-5 grid grid-cols-2 gap-4 overflow-y-scroll">
